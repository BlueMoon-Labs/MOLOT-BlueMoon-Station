...
/obj/item/clothing/accessory/permit/special/bouncer
	...
	permitted_weapons = "Вооружение вторичной категории и специализированного типа, в том числе пистолетов и парализаторов, наручники и их варианты, болы, перцовый баллончик"
