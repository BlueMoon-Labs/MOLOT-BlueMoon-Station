...
/turf/open/floor/iron/shuttle/ferry
	name = "Shuttle Floor"
	icon = 'modular_bluemoon/SmiLeY/mapping/icons/erokez.dmi'
	icon_state = "floor1"

/turf/open/floor/iron/shuttle/ferry/floor
	name = "Shuttle Floor"
	icon = 'modular_bluemoon/SmiLeY/mapping/icons/erokez.dmi'
	icon_state = "floor"

/turf/open/floor/iron/shuttle/ferry/sign_1
	name = "Shuttle Floor"
	icon = 'modular_bluemoon/SmiLeY/mapping/icons/erokez.dmi'
	icon_state = "sign_1"

/turf/open/floor/iron/shuttle/ferry/sign_2
	name = "Shuttle Floor"
	icon = 'modular_bluemoon/SmiLeY/mapping/icons/erokez.dmi'
	icon_state = "sign_2"
...
/turf/open/floor/iron/shuttle/arrivals
	name = "Shuttle Floor"
	icon = 'modular_bluemoon/SmiLeY/mapping/icons/wagon.dmi'
	icon_state = "floor"

/turf/open/floor/iron/shuttle/arrivals/sign_1
	name = "Shuttle Floor"
	icon = 'modular_bluemoon/SmiLeY/mapping/icons/wagon.dmi'
	icon_state = "sign_1"

/turf/open/floor/iron/shuttle/arrivals/sign_2
	name = "Shuttle Floor"
	icon = 'modular_bluemoon/SmiLeY/mapping/icons/wagon.dmi'
	icon_state = "sign_2"

/turf/open/floor/iron/shuttle/arrivals/sign_3
	name = "Shuttle Floor"
	icon = 'modular_bluemoon/SmiLeY/mapping/icons/wagon.dmi'
	icon_state = "sign_3"
