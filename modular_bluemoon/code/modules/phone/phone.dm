 ...
 * Командные телефоны считаются персональными, т.к. мы звоним конкретному главе. Однако на мостике должен стоять один обычный телефон, т.к.
 ...
 * 		и вероятнее всего им будет безразлично на рабочий звонок в отдел.
