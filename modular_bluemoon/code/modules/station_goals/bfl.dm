...
/datum/station_goal/bfl/get_report()
	...
	энергосети, Приемник сооружается прямо над центром жилы, а Линза устанавливается на Приемник. Перед запуском Излучателя убедитесь, что створки \
	Приемника открыты. Если конструкция установлена и настроена правильно, Излучатель сможет направлять лазер точно в Приемник и тот будет собирать \
