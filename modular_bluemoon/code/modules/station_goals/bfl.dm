...
/datum/station_goal/bfl/get_report()
	...
	<br>
	Конструкция состоит из трёх компонентов: Излучателя, Приемника и Линзы. Излучатель устанавливается на станции, Приемник сооружается прямо над центром жилы, а \
	Линза устанавливается над Приемником. Створки Приемника должны быть открыты. Если конструкция установлена и настроена правильно, Излучатель сможет \
