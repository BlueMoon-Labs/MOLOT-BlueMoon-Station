...
/obj/item/clothing/accessory/permit/special/deviant/lust/changeling
	...
	permitted_weapons = "Генокрадские Мутации"
	notes = "Носитель является разумным, экспериментальным существом, имеющим способности генокрада. \
	Носитель не требует авторизации не территории станций во власти ПАКТа. Применение способностей против \
	Службы Безопасности при законном аресте является нарушением со стороны обладателя разрешения и подвержено \
	наказанию по статьям Космического Закона. Применение способностей для поиска жертв для изнасилования и при \
	самозащите от прочего экипажа допустимо. При нарушении любой статьи кода X05 со стороны обладателя разрешения - \
	Службе Безопасности всегда нужно расценивать нарушение как 105."

/obj/item/clothing/accessory/permit/special/deviant/lust/slavers
	name = "Horny Activity Permit"
	desc = "Вещественное одобрение от ЦК."
	permitted_weapons = "Любое неконтрабандное вооружение и контрабанда не выше первой категории"
	notes = "Владелец лицензии является актером, нанятым Центральным командованием, которые имеют право на \
	похищение членов экипажа с использованием имещюегося у них снаряжения. При нарушении любой статьи кода X05 \
	со стороны обладателя разрешения - Службе Безопасности всегда нужно расценивать нарушение как 105."
