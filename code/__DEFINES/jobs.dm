...
#define VANGUARD_OPERATIVE		(1<<9) //BlueMoon edit
...
#define JOB_DISPLAY_ORDER_VANGUARD_OPERATIVE 18 // BLUEMOON ADD
...
#define DEPARTMENT_BITFLAG_SUPPLY (1<<3)
...
#define DEPARTMENT_BITFLAG_LAW (1<<8)
#define DEPARTMENT_LAW "Law"
