	...
	if(HD && !(HAS_TRAIT(H, TRAIT_HUSK)))
		...
		if(!(NOEYES in species_traits))
			...
			if(!has_eyes)
				...
				var/mutable_appearance/left_eye = mutable_appearance('modular_bluemoon/modules/eyes/eyes.dmi', left_state, -BODY_LAYER)
				var/mutable_appearance/right_eye = mutable_appearance('modular_bluemoon/modules/eyes/eyes.dmi', right_state, -BODY_LAYER)
