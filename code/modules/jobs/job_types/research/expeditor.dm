/datum/job/vanguard_operative
	title = "Vanguard operative"
	flag = VANGUARD_OPERATIVE
	...
	outfit = /datum/outfit/job/vanguard_operative
	...
	alt_titles = list("Space Diver", "Gateway Diver", "Space Explorer", "Sexplorer", "Vanguard operative", "Exploration Field Medic", "Exploration Engineer", "Exploration Mercenary", "Exploration Operative")
	display_order = JOB_DISPLAY_ORDER_Vanguard operative
...
/datum/outfit/job/vanguard_operative
	name = "Vanguard operative"
	jobtype = /datum/job/vanguard_operative
	id = /obj/item/card/id
	...
	suit_store = /obj/item/gun/energy/e_gun/mini/vanguard_operative
...
/datum/outfit/job/vanguard_operative/syndicate
	name = "Syndicate Vanguard operative"
	jobtype = /datum/job/vanguard_operative
...
/obj/item/radio/headset/headset_exp
	name = "Vanguard operative's headset"
	desc = "This is used by Vanguard operatives."
...
/obj/item/radio/headset/headset_exp/bowman
	name = "Vanguard operative's bowman headset"
	desc = "This is used by Vanguard operatives. It protects from flashbangs"
	icon_state = "exp_headset_alt"
	item_state = "exp_headset_alt"
	bowman = TRUE

/obj/item/gun/energy/e_gun/mini/vanguard_operative
	name = "Vanguard operative's miniature energy gun"
...
/obj/item/clothing/suit/armor/vest/exp
	...
	desc = "Base armor vest designed for ordinary Vanguard operatives. With cool speedy violet vertical line."
	icon_state = "vest_exp"
	item_state = "vest_exp"
